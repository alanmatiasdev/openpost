...
The full FreeCut parity scoreboard remains in `docs/specs/freecut-parity-audit.md`. The largest reduced areas are advanced dope-sheet gestures and value graphs, three special GPU effects, on-canvas crop/anchor tools, and worker-backed render queue features.
