...
- Matched FreeCut's grading readouts and section workflow with labeled scope guides, parade and vectorscope targets, visible grade actions, adjustment-layer creation, and per-section reset, bypass, and remove controls.
