...
| `OPENPOST_PRIVACY_VERSION`             |                Required in cloud mode | `2026-08-09` in cloud, empty otherwise      | Version stored on the user record when the privacy policy is acknowledged.                                                                                                                                                         |
