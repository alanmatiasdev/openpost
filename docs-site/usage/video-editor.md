...
OpenPost Video Editor is a local-first multitrack editor for social video. Open `/video-editor` in current Chrome or Edge, choose a folder on your computer, and create a project. Editing does not require an account and does not add a watermark.
