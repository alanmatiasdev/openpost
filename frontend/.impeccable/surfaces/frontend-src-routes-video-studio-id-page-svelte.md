---
version: 1
slug: 'frontend-src-routes-video-studio-id-page-svelte'
primary_target: 'frontend/src/routes/video-studio/[id]/+page.svelte'
related_targets: ['frontend/src/lib/video-studio/components/timeline.svelte']
---

# Video Studio Full Studio

- Scope and mode: `frontend/src/routes/video-studio/[id]/+page.svelte`; Operate surface for focused timeline editing. Quick Cut remains the separate no-transcode workflow.
