...
>
	{#each workspaces as workspace, index (workspace.id)}
		<button
			...
			class="flex h-11 min-w-11 items-center justify-center gap-1.5 rounded px-2 text-[11px] font-medium text-[oklch(0.66_0.015_55)] hover:text-white focus-visible:outline-2 focus-visible:outline-[oklch(0.66_0.14_45)] aria-selected:bg-[oklch(0.28_0.018_55)] aria-selected:text-white sm:px-3 md:h-7 md:min-w-8"
