...
export const assetSurfaceManifest = {
  ...
  marketing: [
    ...
    "brand/logo.svg",
    "brand/og-image.png",
    "customer-logos/arc-gym.png",
    "customer-logos/ark.png",
    "customer-logos/dias-solutions.png",
    "customer-logos/enf.svg",
    "customer-logos/montra.svg",
    "customer-logos/the-actual-world.png",
    "customer-logos/unis-easy.png",
    "customer-logos/unprompted.png",
