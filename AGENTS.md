...
- Video Editor Auto preview serializes heavy-media proxy work and keeps proxy visuals separate from original-source audio; stalled proxy seeks may present a bounded filmstrip fallback until the exact frame settles. Full preview and export always use the original source.
