...
- Video Editor Auto preview serializes heavy-media proxy work and keeps proxy visuals separate from original-source audio; Full preview and export always use the original source.
