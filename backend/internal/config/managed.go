...
var managedSettingDefinitions = []ManagedSettingDefinition{
	...
	{Key: "OPENPOST_WHOP_FOUNDER_MONTHLY_PLAN_ID", Group: "billing", Label: "Founder monthly plan ID", Description: "Whop plan used for monthly Founder subscriptions.", Kind: ManagedSettingString, Optional: true, EnvVars: []string{"OPENPOST_WHOP_FOUNDER_MONTHLY_PLAN_ID"}},
	{Key: "OPENPOST_WHOP_FOUNDER_ANNUAL_PLAN_ID", Group: "billing", Label: "Founder annual plan ID", Description: "Whop plan used for annual Founder subscriptions.", Kind: ManagedSettingString, Optional: true, EnvVars: []string{"OPENPOST_WHOP_FOUNDER_ANNUAL_PLAN_ID"}},
...
var managedSettingBindings = map[string]managedSettingBinding{
	...
	"OPENPOST_WHOP_FOUNDER_MONTHLY_PLAN_ID":         stringBinding(func(c *Config) *string { return &c.WhopFounderMonthlyPlanID }),
	"OPENPOST_WHOP_FOUNDER_ANNUAL_PLAN_ID":          stringBinding(func(c *Config) *string { return &c.WhopFounderAnnualPlanID }),
